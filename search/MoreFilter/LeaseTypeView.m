...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.extendLabel = [CustomizeView createLabelWithFrame:CGRectMake(17, self.descriptionLabel.frame.origin.y+self.descriptionLabel.frame.size.height, SCREEN_WIDTH - 45 - 17, 16) :12 :@"PingFangSC-regular" :[UIColor colorWithRed:187.0/255.0 green:187.0/255.0 blue:187.0/255.0 alpha:1.0] :NSTextAlignmentLeft];
